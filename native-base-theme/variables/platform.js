...
export default {
  ...
  // Color
  brandPrimary: platform === "ios" ? "#00aaff" : "#00aaff",
  brandInfo: "#62B1F6",
  brandSuccess: "#5cb85c",
  brandDanger: "#d9534f",
  brandWarning: "#f0ad4e",
  ...
  // FooterTab
  tabBarTextColor: platform === "ios" ? "#00aaff" : "#00aaff",
  tabBarTextSize: platform === "ios" ? 14 : 11,
  activeTab: platform === "ios" ? "#007aff" : "#fff",
  sTabBarActiveTextColor: "#007aff",
  tabBarActiveTextColor: platform === "ios" ? "#fff" : "#fff",
  tabActiveBgColor: platform === "ios" ? "#00aaff" : "#00aaff",

  // Header
  toolbarBtnColor: platform === "ios" ? "#007aff" : "#fff",
  toolbarDefaultBg: platform === "ios" ? "#00aaff" : "#00aaff",
